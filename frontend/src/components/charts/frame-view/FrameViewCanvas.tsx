...
interface FrameViewCanvasProps {
    data: number[][][],
...
export default function FrameViewCanvas({
    data, canvasRefs, handleMouseDown, handleMouseMove, handleMouseUp,
    handleMouseLeave, handleMouseWheel, handleKeyDown, mode
}: FrameViewCanvasProps) {
    return (
        <>
            {data.map((_, idx) => (
                <canvas
